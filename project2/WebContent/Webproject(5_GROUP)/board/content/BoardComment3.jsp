          ...
          $(document).ready(function(){
              ...
              $("#reply_save").click(function(){
                  ...
                  if($("#reply_writer").val().trim() == ""){
                      alert("Please type the name in");
                      $("#reply_writer").focus();
                      return false;
                  }
                   
                  if($("#reply_password").val().trim() == ""){
                      alert("Please type the password in");
                      $("#reply_password").focus();
                      return false;
                  }
                   
                  if($("#reply_content").val().trim() == ""){
                      alert("Please type the word in");
                      $("#reply_content").focus();
                      return false;
                  }
                  ...
                  */
                  ...
                  var reply = 
                      ...
                      '   </td>'+
                      '   <td align="center">'+
                      '       <button name="reply_reply" reply_id = "'+reply_id+'">comment</button>'+
                      '       <button name="reply_modify" r_type = "main" reply_id = "'+reply_id+'">modify</button>      '+
                      '       <button name="reply_del" reply_id = "'+reply_id+'">delete</button>      '+
                      '   </td>'+
                      '</tr>';
              ...
              $(document).on("click","button[name='reply_modify']", function(){
                  ...
                  */
                  ...
                  if(status){
              		alert("Modification and double reply cannot be done together");
              		return false;
              	}
                  ...
                  if(check){
                      ...
                      var replyEditor = 
                         ...
                         '   </td>'+
                         '   <td width="100px">'+
                         '       <input type="text" name="reply_modify_writer_'+reply_id+'" id="reply_modify_writer_'+reply_id+'" style="width:100%;" maxlength="10" placeholder="writer" value="'+txt_reply_writer+'"/>'+ //기존 작성자 넣기
                         '   </td>'+
                         '   <td width="100px">'+
                         ...
                         '   </td>'+
                         '   <td align="center">'+
                         '       <button name="reply_modify_save" r_type = "'+r_type+'" reply_id="'+reply_id+'">register</button>'+
                         '       <button name="reply_modify_cancel" r_type = "'+r_type+'" r_content = "'+txt_reply_content+'" r_writer = "'+txt_reply_writer+'" reply_id="'+reply_id+'">cancel</button>'+
                         '   </td>'+
                         '</tr>';
              ...
              $(document).on("click","button[name='reply_modify_cancel']", function(){
              	...
              	if(r_type=="main"){
              		...
              		reply = 
                          ...
                          '   </td>'+
                          '   <td align="center">'+
                          '       <button name="reply_modify" r_type = "sub" reply_id = "'+reply_id+'">modify</button>'+
                          '       <button name="reply_del" reply_id = "'+reply_id+'">delete</button>'+
                          '   </td>'+
                          '</tr>';
              	}
                  ...
                  */
                  ...
                  if(r_type=="main"){
              		reply = 
                          ...
                          '       <button name="reply_reply" reply_id = "'+reply_id+'">comment</button>'+
                          '       <button name="reply_modify" r_type = "main" reply_id = "'+reply_id+'">modify</button>      '+
                          '       <button name="reply_del" reply_id = "'+reply_id+'">delte</button>      '+
                          '   </td>'+
                          '</tr>';
              	}else{
              		reply = 
              ...
              $(document).on("click","button[name='reply_reply']",function(){ //동적 이벤트
              	...
              	if(status){
              		alert(" Modification and double reply cannot be proceeded at the moment");
              		return false;
              	}
                  ...
                  var replyEditor = 
                     ...
                     '   </td>'+
                     '   <td width="100px">'+
                     '       <input type="text" name="reply_reply_writer" style="width:100%;" maxlength="10" placeholder="writer"/>'+
                     '   </td>'+
                     '   <td width="100px">'+
                     '       <input type="password" name="reply_reply_password" style="width:100%;" maxlength="10" placeholder="password"/>'+
                     '   </td>'+
                     '   <td align="center">'+
                     '       <button name="reply_reply_save" reply_id="'+reply_id+'">register</button>'+
                     '       <button name="reply_reply_cancel">cancel</button>'+
                     '   </td>'+
                     '</tr>';
              ...
              $("#modify").click(function(){
                  ...
                  //ajax 호출
                 	alert("If the password is right then move on to the modification page");
                  /*
                  $.ajax({
                      url         :   "/board/check",
                      dataType    :   "json",
              ...
              $("#delete").click(function(){
                  ...
                  alert("If the password is right then delete the content and move on the the list page");
                  /*                 
                  //ajax 호출
                  $.ajax({
                      url         :   "/board/del",
  ...
  <body>
      ...
      <div align="center">
          ...
          <table border="1" width="1200px" bordercolor="#46AA46">
              <tr>
                  <td width="500px">
                      Name: <input type="text" id="reply_writer" name="reply_writer" style="width:170px;" maxlength="10" placeholder="writer"/>
                      Password: <input type="password" id="reply_password" name="reply_password" style="width:170px;" maxlength="10" placeholder="password"/>
                      ...
                      <button id="reply_save" name="reply_save">register the comment</button>
                  </td>
              </tr>
              <tr>
                  <td>
                      <textarea id="reply_content" name="reply_content" rows="4" cols="50" placeholder="Please put the word in"></textarea>
                  </td>
              </tr>
          </table>
          <table width="1200px">
              <tr>
                  <td align="right">
                      <button id="list" name="list">board</button>
                  </td>
              </tr>
          </table>
      </div>
