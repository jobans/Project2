...
.pop_container .drag_area .bg{display:block;position:absolute;top:0;left:0;width:341px;height:129px;background:#fdfdfd url(./bg_drag_image.png) 0 0 no-repeat}
...
<div id="pop_wrap">
	...
	<div id="pop_container2" class="pop_container2">
		...
		<div id="pop_footer">
		    <div class="btn_area">
	            <a href="javascript:fn_imageUp();"><img src="./btn_confirm.png" width="49" height="28" alt="확인" id="btn_confirm"></a>
	            <a href="#"><img src="./btn_cancel.png" width="48" height="28" alt="취소" id="btn_cancel"></a>
	        </div>
    	</div>
        <!-- //content -->
    ...
    <div id="pop_container" class="pop_container" style="display:none;">
		...
		<div id="pop_footer">
	    <div class="btn_area">
            <a href="javascript:fn_imageUp5();"><img src="./btn_confirm.png" width="49" height="28" alt="확인" id="btn_confirm"></a>
            <a href="#"><img src="./btn_cancel.png" width="48" height="28" alt="취소" id="btn_cancel"></a>
        </div>
    </div>
        <!-- //content -->
